...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("**BOMBA COMBUSTIVEL**");
        System.out.println("");
        ...
        bomba.abastecerPorValor(180.0f);
        System.out.println("");

        System.out.printf("** Litros combustivel disponivel: %.2f\n", bomba.getQuantidadeCombustivel());
        System.out.println("");

        bomba.abastecerPorLitro(13.34f);
        System.out.println("");

        System.out.printf("** Litros combustivel disponivel: %.2f\n", bomba.getQuantidadeCombustivel());
        System.out.println("");

        bomba.alterarQuantidadeCombustivel(bomba.setQuantidadeCombustivel(200.0f));

        System.out.printf("** Litros combustivel disponivel: %.2f\n", bomba.getQuantidadeCombustivel());
        System.out.println("");

        bomba.alterarCombustivel(bomba.setCombustivel("Diesel"));
        bomba.alterarValor(6.01f);

        System.out.println("Novo combustivel: " + bomba.getCombustivel() +
                " | Preço atualizado R$: " + bomba.getValorCombustivel());
